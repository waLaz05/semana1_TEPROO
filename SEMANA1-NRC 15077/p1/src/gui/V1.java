...
public class V1 extends JFrame implements ActionListener {
	...
	public V1() {
		...
		}
		{
			...
			lblNewLabel_1.setBounds(170, 11, 46, 14);
		...
		}
		{
			...
			lblNewLabel_3.setBounds(170, 36, 46, 14);
			contentPane.add(lblNewLabel_3);
		}
		{
			txtCod = new JTextField();
			txtCod.setBounds(59, 9, 86, 20);
			contentPane.add(txtCod);
			txtCod.setColumns(10);
		}
		{
			txtNom = new JTextField();
			txtNom.setBounds(226, 9, 86, 20);
			contentPane.add(txtNom);
			txtNom.setColumns(10);
		}
		{
			txtN1 = new JTextField();
			txtN1.setBounds(59, 35, 86, 20);
			contentPane.add(txtN1);
			txtN1.setColumns(10);
		}
		{
			txtN2 = new JTextField();
			txtN2.setBounds(226, 34, 86, 20);
		...
		}
		{
			...
			btnNewButton_1.setBounds(101, 67, 89, 23);
			contentPane.add(btnNewButton_1);
		}
		{
			btnNewButton_2 = new JButton("Eliminar");
			btnNewButton_2.addActionListener(this);
			btnNewButton_2.setBounds(193, 67, 89, 23);
			contentPane.add(btnNewButton_2);
		}
		{
			btnNewButton_3 = new JButton("Buscar");
			btnNewButton_3.addActionListener(this);
			btnNewButton_3.setBounds(286, 67, 86, 23);
			contentPane.add(btnNewButton_3);
		}
		{
			btnNewButton_4 = new JButton("Modificar");
			btnNewButton_4.addActionListener(this);
			btnNewButton_4.setBounds(375, 67, 89, 23);
			contentPane.add(btnNewButton_4);
		}
		{
			txtS = new JTextArea();
			txtS.setBounds(10, 119, 452, 186);
